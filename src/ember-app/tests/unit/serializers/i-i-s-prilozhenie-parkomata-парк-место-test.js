...
moduleForModel('i-i-s-prilozhenie-parkomata-парк-место', 'Unit | Serializer | i-i-s-prilozhenie-parkomata-парк-место', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-parkomata-парк-место',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
