...
moduleForModel('i-i-s-prilozhenie-parkomata-паркомат', 'Unit | Serializer | i-i-s-prilozhenie-parkomata-паркомат', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-parkomata-паркомат',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
