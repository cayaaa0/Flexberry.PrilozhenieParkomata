...
moduleForModel('i-i-s-prilozhenie-parkomata-водитель', 'Unit | Serializer | i-i-s-prilozhenie-parkomata-водитель', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-parkomata-водитель',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
