...
moduleForModel('i-i-s-prilozhenie-parkomata-парковка', 'Unit | Serializer | i-i-s-prilozhenie-parkomata-парковка', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-prilozhenie-parkomata-парковка',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
