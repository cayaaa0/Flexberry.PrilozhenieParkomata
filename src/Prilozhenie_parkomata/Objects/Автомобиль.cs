...
namespace IIS.Prilozhenie_parkomata
{
    ...
    public class Автомобиль : ICSSoft.STORMNET.DataObject
    {
        ...
        private IIS.Prilozhenie_parkomata.Водитель fВодитель;
        ...
        [PropertyStorage(new string[] {
                "Водитель"})]
        [NotNull()]
        public virtual IIS.Prilozhenie_parkomata.Водитель Водитель
        {
            get
            {
                ...
                IIS.Prilozhenie_parkomata.Водитель result = this.fВодитель;
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View АвтомобильE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АвтомобильE", typeof(IIS.Prilozhenie_parkomata.Автомобиль));
                }
            }
            ...
            public static ICSSoft.STORMNET.View АвтомобильL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("АвтомобильL", typeof(IIS.Prilozhenie_parkomata.Автомобиль));
                }
            }
        }
    }
